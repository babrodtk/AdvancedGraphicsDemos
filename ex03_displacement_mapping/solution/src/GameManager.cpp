...
void GameManager::createSimpleProgram() {
	...
	glUniform1i(program->getUniform("height_texture"), 0); //< 0 means GL_TEXTURE0
	glUniform1i(program->getUniform("color_texture"), 1); //< 1 means GL_TEXTURE1
...
void GameManager::init() {
	...
	height_texture = loadTexture("ex03_height.bmp");
	color_texture = loadTexture("ex03_tex.bmp");
}

void GameManager::render() {
	double elapsed = my_timer.elapsedAndRestart();
	float rotate_degrees = elapsed * 10.0;
